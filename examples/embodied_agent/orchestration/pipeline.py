...
from vigil.observability.vizgraph import GraphSnapshotRecorder
from vigil.perception import WorldState
from vigil.perception.detectors.yolo import run_world_state_tracking_loop
from vigil.perception.frame_provider import FrameSourceMode
from vigil.tools import TOOL_SCHEMAS, ToolDispatcher
...
from .aux_context import _build_auxiliary_context_with_fallback
...
def _resolve_interactive_log_path(log_file: str | None) -> Path:
    ...
    return _REPO_ROOT / "artifacts" / "logs" / f"interactive-{timestamp}.log"
...
def run_pipeline(
    ...
    if graph_snapshot_interval > 0:
        ...
        graph_output_dir = _REPO_ROOT / "artifacts" / "graphs" / graph_run_id
